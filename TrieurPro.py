...
def Valider():
    if not(rep_src):
        text_err_valider.set("Pas de dossier source")
        label_err_valider.configure(text_color = "chocolate1")
        label_err_valider.place(x = 500, y = 200)
        return 0
    if not(rep_dest):
        text_err_valider.set("Pas de dossier destination")
        label_err_valider.configure(text_color = "chocolate1")
        label_err_valider.place(x = 500, y = 200)
        return 0
    if (cpi() == 0):
        text_err_valider.set("Copier ou deplacer pas coché")
        label_err_valider.configure(text_color = "chocolate1")
        label_err_valider.place(x = 500, y = 200)
        return 0
    if (nei() == 0):
        text_err_valider.set("Nouveau ou dossier existant pas coché")
        label_err_valider.configure(text_color = "chocolate1")
        label_err_valider.place(x = 500, y = 200)
        return 0
    else:	
...
label_info_gen.place(x = 30, y = 250)
