...
def Valider():
    ...
    if not(exp_ext.get()) or not(exp_mc()):
    ...
    if (rep_src and rep_dest and cpi() == 1 and nei() == 1):	
...
rec = customtkinter.CTkCheckBox(master=root, text="Parcours Récursif", width=140    , font = font ,variable=check_var, onvalue="on", offvalue="off")
